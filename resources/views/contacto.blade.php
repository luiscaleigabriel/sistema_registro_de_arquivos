...
@section('content')
    <!-- Page Header -->
    <section class="py-5"
        style="background: linear-gradient(rgba(30, 58, 138, 0.9), rgba(30, 58, 138, 0.8)),
                    ...
                    <div class="card border-0 shadow-lg">
                        <div class="card-body p-5">
                            ...
                            <form id="contactForm" action="{{ route('contacto.submit') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="mensagem" name="mensagem" placeholder="Sua mensagem" style="height: 150px" required></textarea>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item border-0 shadow-sm mb-3">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    São necessários: BI, certificado de habilitações, fotografia e comprovativo de
                                    residência.
