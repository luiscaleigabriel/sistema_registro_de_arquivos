        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="dashboard-card">
                    ...
                    <form method="POST" action="{{ route('aluno.inscricao.store') }}" enctype="multipart/form-data"
                        id="inscricaoForm">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="ano_letivo" name="ano_letivo" required>
                                        ...
                                        @for ($i = date('Y'); $i <= date('Y') + 2; $i++)
                                            <option value="{{ $i }}/{{ $i + 1 }}"
                                                {{ $aluno->ano_letivo == $i . '/' . ($i + 1) ? 'selected' : '' }}>
                                                {{ $i }}/{{ $i + 1 }}
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="taxa" value="10.000,00"
                                            readonly>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    ...
                                                    <select class="form-select tipo-documento" name="tipo_documentos[]"
                                                        required>
                                                        <option value="">Selecione o tipo</option>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <small class="text-muted">Formatos: PDF, JPG, PNG, DOC (max:
                                                        5MB)</small>
                                                </div>
                        ...
                        <div id="step3" style="display: none;">
                            ...
                            <div class="alert alert-success mb-4">
                                ...
                                <strong>Pronto para enviar!</strong> Revise as informações abaixo antes de submeter sua
                                inscrição.
                            </div>
                            ...
                            <div class="form-check mb-4">
                                ...
                                <label class="form-check-label" for="confirmacao">
                                    Declaro que as informações fornecidas são verdadeiras e que compreendo os termos da
                                    inscrição.
                                </label>
                            </div>
    ...
    <script>
        ...
        function updateReview() {
            document.getElementById('reviewTipo').textContent =
                document.getElementById('tipo_inscricao').options[document.getElementById('tipo_inscricao').selectedIndex]
                .text;
